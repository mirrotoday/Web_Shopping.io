			...
			<div>
				...
				<div style="margin-top:5px;margin-left:150px;">
					...
					<p>
						...
						<br/>
						<br/>
						<input type="radio" name="pd_FrpId" value="CCB-NET-B2C" />微信支付
						<img src="${pageContext.request.contextPath}/bank_img/weixin.jpg" align="middle" />
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="pd_FrpId" value="CCB-NET-B2C" />支付宝支付
						<img src="${pageContext.request.contextPath}/bank_img/zhifubao.jpg" align="middle" />
